...
public class PerformanceVendor extends BaseContentPanel {
    ...
    private final VendorModel user;
    ...
    public PerformanceVendor(VendorModel user) {
        this.user = user;
    ...
    private Node createHeader() {
        return new TitleBackButton("Revenue Summary", () -> {
            ManagerViewModel.getVendorPerformanceViewModel().navigate(
                    ManagerViewModel.getVendorPerformanceViewModel().getVendorListUI());
        });
    }
