...
public class ReviewUI extends BaseContentPanel {
    ...
    private Node errorContent() {
        Label errorLabel = new Label("No vendor found.");
        errorLabel.setFont(Font.font("Arial", FontWeight.MEDIUM, 16));
        errorLabel.setTextFill(Color.GRAY);

        return errorLabel;
    }

    public ReviewUI(String vendorId) {
        super();
